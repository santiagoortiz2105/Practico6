...
public class frmGestiondeProductos extends javax.swing.JFrame {
   ...
   //Categorias
    ...
    jComboBox1.addItem("Farmacia");
    jComboBox1.addItem("Bazar");
    ...
    private void initComponents() {
     ...
     private void inicializarTabla() {
        modeloTabla = new DefaultTableModel(
            new Object[]{"Nombre", "Categoría", "Precio"}, 0
        ) {
            @Override
       ...
       private void configurarEventos() {
        jBotonAgregar.addActionListener(new ActionListener() {
    ...
    private void agregarProducto() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Ingrese un número válido en precio.",
                    "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmGestiondeProductos().setVisible(true);
            }
        });
      }
